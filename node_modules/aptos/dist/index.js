...
var IndexerClient = class {
  ...
  async queryIndexer(graphqlQuery) {
    const { data } = await import_axios.default.post(this.endpoint, graphqlQuery);
    if (data.errors) {
  ...
  async getAccountNFTs(ownerAddress, options) {
    const graphqlQuery = {
      ...
      variables: { address: ownerAddress, offset: options == null ? void 0 : options.offset, limit: options == null ? void 0 : options.limit }
    };
    return this.queryIndexer(graphqlQuery);
  }
  async getTokenActivities(idHash) {
    const graphqlQuery = {
...
import_axios2.default.interceptors.response.use((response) => {
...
import_axios2.default.interceptors.request.use(function(config) {
...
var sendRequest = async (config, options, url, body, formData, headers, onCancel) => {
  ...
  try {
    return await import_axios2.default.request(requestConfig);
  } catch (error) {
...
// src/providers/faucet_client.ts
