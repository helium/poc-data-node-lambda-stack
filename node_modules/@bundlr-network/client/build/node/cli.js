...
program
    ...
    try {
        ...
        console.log(`Price for ${bytes} bytes in ${options.currency} is ${cost.toFixed(0)} ${bundlr.currencyConfig.base[0]} (${bundlr.utils
            .unitConverter(cost)
...
async function init(opts, operation) {
    ...
    try {
        ...
        bundler = new bundlr_1.default(opts.host, opts.currency.toLowerCase(), wallet !== null && wallet !== void 0 ? wallet : "", {
