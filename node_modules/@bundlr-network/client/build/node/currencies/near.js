...
class NearConfig extends currency_1.default {
    ...
    ownerToAddress(owner) {
        return Buffer.from(typeof owner === "string" ? (0, bs58_1.decode)(owner.replace("ed25519:", "")) : (0, bs58_1.decode)((0, bs58_1.encode)(owner))).toString("hex");
    }
    async sign(data) {
    ...
    async ready() {
        ...
        try {
            ...
            const resolved = (await axios_1.default.get(`${this.bundlrUrl}account/near/lookup?address=${base64url_1.default.encode(pubkey.split(":")[1])}`).catch((e) => {
                return e;
            }));
