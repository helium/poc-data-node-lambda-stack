...
function getCurrency(currency, wallet, providerUrl, contractAddress) {
    switch (currency) {
        ...
        case "aptos":
            return new aptos_1.default({ name: "aptos", ticker: "APTOS", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://fullnode.mainnet.aptoslabs.com/v1", wallet });
        default:
